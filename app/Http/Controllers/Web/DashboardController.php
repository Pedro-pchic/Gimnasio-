    ...
    public function __invoke(): View
    {
        ...
        return view('dashboard', [
            'statistics' => [
                ...
                ['label' => 'Clases llenas', 'value' => $todaySchedules->filter(fn (GymClassSchedule $schedule): bool => $schedule->enrolled_today_count >= $schedule->maximum_capacity)->count()],
                ['label' => 'Cupos disponibles hoy', 'value' => $todaySchedules->sum(fn (GymClassSchedule $schedule): int => max(0, $schedule->maximum_capacity - $schedule->enrolled_today_count))],
